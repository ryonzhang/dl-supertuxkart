...
def train(args):
    ...
    train_data = load_detection_data('dense_data_final/train', num_workers=64, transform=transform)
    valid_data = load_detection_data('dense_data_final/valid', num_workers=64, transform=valid_transform)
